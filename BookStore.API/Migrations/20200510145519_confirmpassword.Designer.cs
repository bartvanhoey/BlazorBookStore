...
namespace BookStore.API.Migrations
{
    ...
    [Migration("20200510145519_confirmpassword")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStore.Model.Job", b =>
                {
            ...
            modelBuilder.Entity("BookStore.Model.RefreshToken", b =>
                {
            ...
            modelBuilder.Entity("BookStore.Model.Sale", b =>
                {
            ...
            modelBuilder.Entity("BookStore.Model.Store", b =>
                {
                    b.Property<string>("StoreId")
                        .HasColumnName("store_id")
                        .HasColumnType("char(4)")
            ...
            modelBuilder.Entity("BookStore.Model.Book", b =>
                {
                    b.HasOne("BookStore.Model.Publisher", "Pub")
                        .WithMany("Books")
                        .HasForeignKey("PubId")
            ...
            modelBuilder.Entity("BookStore.Model.Sale", b =>
                {
                    ...
                    b.HasOne("BookStore.Model.Store", "Store")
                        .WithMany("Sales")
