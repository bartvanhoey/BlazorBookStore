...
namespace BookStore.API.Migrations
{
    ...
    [Migration("20200507132058_usertable_update3")]
    partial class usertable_update3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStore.API.Models.Job", b =>
                {
            ...
            modelBuilder.Entity("BookStore.API.Models.RefreshToken", b =>
                {
            ...
            modelBuilder.Entity("BookStore.API.Models.Store", b =>
                {
                    b.Property<string>("StoreId")
                        .HasColumnName("store_id")
                        .HasColumnType("char(4)")
            ...
            modelBuilder.Entity("BookStore.API.Models.Book", b =>
                {
                    b.HasOne("BookStore.API.Models.Publisher", "Pub")
                        .WithMany("Books")
                        .HasForeignKey("PubId")
            ...
            modelBuilder.Entity("BookStore.API.Models.Sale", b =>
                {
                    ...
                    b.HasOne("BookStore.API.Models.Store", "Store")
                        .WithMany("Sales")
